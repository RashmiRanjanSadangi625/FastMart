  ...
  return (
    <section className="bg-white py-10 px-6 lg:px-20">
      <div className="max-w-6xl mx-auto text-center pb-6">
        {/* Section Heading */}
        <h2 className="text-6xl font-bold text-gray-900">Brands</h2>
      ...
      <div className="max-w-10xl mx-auto flex flex-col md:flex-row items-center gap-10 mt-12">
        ...
        <div className="md:w-1/2 text-left">
          <h2 className="text-3xl font-bold text-gray-900">
            <span className="text-blue-600">Great service always syrocket the business</span> ultimately,
            ,Building brands.
          </h2>
        ...
        <div className="md:w-1/2 grid grid-cols-3 gap-4">
          {brands.map((brand, index) => (
            <div
              key={index}
              className="border border-gray-300 bg-white p-6 rounded-lg flex items-center justify-center shadow-sm hover:shadow-md transition-all"
            >
              <p>{brand.name}</p>
            </div>
          ))}
